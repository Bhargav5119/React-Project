    ...
    return (
        <div className={styles.form}>
            <div className={styles.title}>
                <h1>Add New</h1>
                <GrClose onClick={CreateNew} size={18} />
            </div>
            <hr />
            <div className={styles.container}>
                ...
                <div className={styles.right_container}>
                    ...
                    <div className={styles.btn_container}>
                        <button onClick={() => { dispatch(Addtask(formData)); setFormData(initial); CreateNew() }}>Save</button>
                        <button onClick={() => setFormData(initial)} name="delete">Reset</button>
                    </div>
                </div>
            </div>
        </div>
